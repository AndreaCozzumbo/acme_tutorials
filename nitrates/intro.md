...
<div style="text-align: center; margin: 3em 0;">
  <a href="https://www.icloud.com/keynote/078zNyt41dm_FMt5ZqYPB6Mug#nitrates_acme" target="_blank" style="display: inline-block; padding: 1.5em 3em; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; text-decoration: none; border-radius: 12px; font-size: 1.3em; font-weight: 600; box-shadow: 0 10px 30px rgba(102, 126, 234, 0.4); transition: all 0.3s;">
